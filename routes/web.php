...
Route::prefix('users')->group(function() {
    ...
    Route::get('/edit/{id}', [UserController::class, 'UserUpdate'] )->name('user.edit');
    Route::post('/update/{id}', [UserController::class, 'UserChange'] )->name('user.update');
    Route::get('/delete/{id}', [UserController::class, 'UserDelete'] )->name('user.delete');
    //Route::get('/profile/{$id}', [UserController::class, 'UserView'] )->name('users.view');
