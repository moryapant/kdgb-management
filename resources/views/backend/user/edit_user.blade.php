      ...
      <section class="content">
        ...
        <!-- errrors display for validation --->   
                    ...
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="text" name="name" value="{{$data->name}}" class="form-control" required data-validation-required-message="This field is required" value="{{ old('name') }}"> </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <input type="email" name="email" value="{{$data->email}}"" class="form-control" required data-validation-required-message="This field is required" value="{{ old('email') }}"> </div>
                    </div>
                    {{-- <div class="form-group">
